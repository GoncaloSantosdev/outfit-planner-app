  ...
  return (
    <>
      <button className="btn" onClick={() => {
          ...
          console.log("Top dressCode", topArr[randomClothArrIndex(topArr)].dressCode);

          setBottom(bottomArr[randomClothArrIndex(bottomArr)].imageUrl);
          console.log("Bottom dressCode", bottomArr[randomClothArrIndex(bottomArr)].dressCode);

          setShoes(shoeArr[randomClothArrIndex(shoeArr)].imageUrl);
          console.log( "Shoes dressCode", shoeArr[randomClothArrIndex(shoeArr)].dressCode);
        }}
      >
        {style}
      </button>
